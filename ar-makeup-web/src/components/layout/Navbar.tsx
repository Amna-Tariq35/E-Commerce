        ...
        <div className="flex items-center gap-2">
          ...
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              <path d="M6 6h15l-2 9H8L6 6Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
              <path d="M6 6 5 3H2" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
              <path d="M9 21a1 1 0 1 0 0-2 1 1 0 0 0 0 2ZM18 21a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" stroke="currentColor" strokeWidth="1.5" />
            </svg>
            {cartCount > 0 && (
          ...
          <div className="relative" ref={menuRef}>
            ...
            {sessionState === "signed_in" && isMenuOpen && (
              <div className="absolute right-0 mt-2 w-56 overflow-hidden rounded-2xl border border-black/10 bg-white/70 shadow-xl backdrop-blur">
                <div className="px-4 py-3 text-xs text-black/55">My Account</div>
